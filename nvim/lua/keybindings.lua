...
-- Files (scoped)
vim.api.nvim_set_keymap("n", "<Leader>fa", "<Cmd>lua require('telescope.builtin').find_files{ cwd = vim.fn.expand('~') }<CR>", opts)
vim.api.nvim_set_keymap("n", "<Leader>fr", "<Cmd>lua require('telescope.builtin').find_files{ cwd = vim.fn.expand('~/repos')}<CR>", opts)
vim.api.nvim_set_keymap("n", "<Leader>fn", "<Cmd>lua require('telescope.builtin').find_files{ cwd = vim.fn.expand('~/Documents/Notes')}<CR>", opts)
vim.api.nvim_set_keymap("n", "<Leader>fc", "<Cmd>lua require('telescope.builtin').find_files{ cwd = vim.fn.expand('~/.config')}<CR>", opts)
...
vim.api.nvim_set_keymap("n", "<Leader>ga", "<Cmd>lua require('telescope.builtin').live_grep{ cwd = vim.fn.expand('~')}<CR>", opts)
vim.api.nvim_set_keymap("n", "<Leader>gr", "<Cmd>lua require('telescope.builtin').live_grep{ cwd = vim.fn.expand('~/repos')}<CR>", opts)
vim.api.nvim_set_keymap("n", "<Leader>gn", "<Cmd>lua require('telescope.builtin').live_grep{ cwd = vim.fn.expand('~/Documents/Notes')}<CR>", opts)
vim.api.nvim_set_keymap("n", "<Leader>gc", "<Cmd>lua require('telescope.builtin').live_grep{ cwd = vim.fn.expand('~/.config')}<CR>", opts)
